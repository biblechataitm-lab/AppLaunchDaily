  ...
  return (
    <header ref={headerRef} className={`ald-nav ${scrolled ? 'ald-nav-scrolled' : ''}`}>
      <div className="ald-nav-inner">
        <Link href="/" className="ald-nav-brand">
        ...
        <nav className="ald-nav-links">
          <Link href="/trends" className={`ald-nav-link ${pathname === '/trends' ? 'active' : ''}`}>
            <TrendingUp size={13} /> Trends
          </Link>
          <Link href="/sponsor" className={`ald-nav-link ${pathname === '/sponsor' ? 'active' : ''}`}>Sponsor</Link>
          <Link href="/submit" className="ald-nav-cta"><PlusCircle size={14} /> Submit</Link>
        </nav>
